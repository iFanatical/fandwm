...
static const char *fonts[]          = { "JetBrainsMonoNL Nerd Font Propo:bold:pixelsize=14:antialias=true:autohint=false" };
...
static const char col_mag[]        = "#7aa2f7";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_mag,  col_mag  },
};
